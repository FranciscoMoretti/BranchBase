...
import { parseWorktreeList } from "../adapters/git/discover-worktrees";
...
import { loadBranchBaseConfig } from "../configuration/branchbase-config";
import { commandWorkingDirectory } from "../configuration/command-directory";
import { trustRepository as saveRepositoryTrust } from "../configuration/repository-trust";
import {
  appGroupCanRestart,
  appsCanRestart,
