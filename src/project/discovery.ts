...
import { DetectedServices } from "../adapters/host/detected-services";
import { pathInside } from "../adapters/host/ports";
import { processTreeUsage } from "../adapters/host/process-usage";
import { findBranchBaseConfig } from "../configuration/branchbase-config";
import type { ProductStore } from "./catalog";
